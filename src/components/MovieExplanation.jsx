...
const MovieExplanation = ({ movie, handleSelectedMovie }) => {
  ...
  return (
     <div className='h-[550px] w-full relative'>
      ...
      <div className='absolute top-[30%] pl-4 flex flex-col gap-5'>
        ...
        <button onClick={() => {handleSelectedMovie(movie)}} className='text-white w-fit border-solid border-[1px] cursor-pointer border-gray-300 px-5 py-3'>More Information</button>
