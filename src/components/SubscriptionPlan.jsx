    ...
    <div className="mt-32">
      ...
      <div className="flex gap-5 md:gap-12 mt-10 text-center md:pl-[33%] border-b-white border-b-2 z-50 bg-black sticky top-0">
        <div className="w-1/3 pt-4 md:px-3">
          <button className="text-white text-lg h-14 rounded w-full bg-red-600 hover:bg-red-800">
            Standard with ads
          </button>
        ...
        <div className="w-1/3 pt-4 md:px-3 md:bg-[#759AAB] md:bg-opacity-20">
          <button className="text-white text-lg h-14 rounded w-full bg-red-700 hover:bg-red-900">
            Premium
          </button>
